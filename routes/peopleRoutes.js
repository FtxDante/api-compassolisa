...
const { AllRequireValidation, IdValidation } = require('../app/validation/people');
...
module.exports = (server, routes, prefix = '/api/v1') => {
  ...
  routes.put('/people/:id', IdValidation, AllRequireValidation, PeopleController.updateOnePerson);
  routes.delete('/people/:id', IdValidation, PeopleController.deleteOne);
